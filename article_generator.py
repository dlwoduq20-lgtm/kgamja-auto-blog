...
ARCHETYPES_KR = [
    {
        ...
        "instruction": (
            ...
            "1. 객관적 문제제기 및 분쟁 사례 도입부 + 검증일자 포함 검증준칙 박스 (1인칭 개인 경험담 어조 절대 금지)\n"
            "2. '골든타임 긴급 행동 수칙': 당일 즉시 확보해야 할 3대 증거 자료\n"
            "3. 법원/관공서 단계별 해결 절차 (원칙-요건-예외-사례 순서 동적 H2/H3)\n"
    ...
    },
    {
        ...
        "instruction": (
            ...
            "3. 상대방의 반박/이의신청을 무력화하는 객관적 증거 채증 요령 (원칙-요건-예외-사례 순서 동적 H2/H3)\n"
    ...
    },
    {
        ...
        "instruction": (
            ...
            "3. 분기별 실무 대처법과 전자소송 접수 요령 (원칙-요건-예외-사례 순서 동적 H2/H3)\n"
