...
ARCHETYPES_JP = [
    {
        ...
        "instruction": (
            ...
            "1. 客観的トラブル事例・問題提起導入部 + 検証日入り監修基準ボックス（架空の一人称体験談トーン厳禁）\n"
            "2. 『初動対応の鉄則』：トラブル当日に即時確保すべき重要証拠3選\n"
            "3. 裁判所・公的機関のステップ別手続きマニュアル（原則-要件-例外-手順の順で動的H2/H3）\n"
    ...
    },
    {
        ...
        "instruction": (
            ...
            "3. 相手方の反論や不当請求を無効化する客観的立証資料の集め方（原則-要件-例外-手順の順で動的H2/H3）\n"
            "4. 費用・期間比較HTML <table>\n"
            "5. 『あなたの状況に最適な解決手順マトリクス (Decision Matrix)』表\n"
            "6. 実務FAQ（FAQPage schema）\n"
            "7. 根拠法令および公的機関出典（Sources & References）セクション"
    ...
    },
    {
        ...
        "instruction": (
            ...
            "3. 分岐別実務対応と申立書・内容証明作成の要点（原則-要件-例外-手順の順で動的H2/H3）\n"
