...
4. 이미지 묘사 프롬프트 (Image Prompt):
   - 글의 상황을 정확하게 시각화할 수 있는 **상세한 영문 AI 이미지 생성 프롬프트** 작성
   - 만화스럽지 않고 깔끔하며 세련된 한국적 맥락의 일러스트/디지털 아트 스타일
   - 예시: "A modern digital illustration of a worried Korean tenant discussing with a landlord about wallpaper and flooring repair invoice in a small studio apartment, clean aesthetic, realistic modern Korean room, no text, highly detailed"
